...
* Renovate configuration for weekly PHP base-image, GitHub Actions, and PHP extension updates. GitHub-hosted extension releases remain pinned by immutable commit, with each tag and commit updated together.
